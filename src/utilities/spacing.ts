...
export const spacingUtilities = StyleSheet.create({
  ...
  // ====================
  // SPACE UTILITIES (for flex children)
  // ====================

  "space-x-0": { marginLeft: 0, marginRight: 0 },
  "space-x-px": { marginLeft: 1, marginRight: 1 },
  "space-x-0.5": { marginLeft: 2, marginRight: 2 },
  "space-x-1": { marginLeft: 4, marginRight: 4 },
  "space-x-1.5": { marginLeft: 6, marginRight: 6 },
  "space-x-2": { marginLeft: 8, marginRight: 8 },
  "space-x-2.5": { marginLeft: 10, marginRight: 10 },
  "space-x-3": { marginLeft: 12, marginRight: 12 },
  "space-x-3.5": { marginLeft: 14, marginRight: 14 },
  "space-x-4": { marginLeft: 16, marginRight: 16 },
  "space-x-5": { marginLeft: 20, marginRight: 20 },
  "space-x-6": { marginLeft: 24, marginRight: 24 },
  "space-x-7": { marginLeft: 28, marginRight: 28 },
  "space-x-8": { marginLeft: 32, marginRight: 32 },

  "space-y-0": { marginTop: 0, marginBottom: 0 },
  "space-y-px": { marginTop: 1, marginBottom: 1 },
  "space-y-0.5": { marginTop: 2, marginBottom: 2 },
  "space-y-1": { marginTop: 4, marginBottom: 4 },
  "space-y-1.5": { marginTop: 6, marginBottom: 6 },
  "space-y-2": { marginTop: 8, marginBottom: 8 },
  "space-y-2.5": { marginTop: 10, marginBottom: 10 },
  "space-y-3": { marginTop: 12, marginBottom: 12 },
  "space-y-3.5": { marginTop: 14, marginBottom: 14 },
  "space-y-4": { marginTop: 16, marginBottom: 16 },
  "space-y-5": { marginTop: 20, marginBottom: 20 },
  "space-y-6": { marginTop: 24, marginBottom: 24 },
  "space-y-7": { marginTop: 28, marginBottom: 28 },
  "space-y-8": { marginTop: 32, marginBottom: 32 },
